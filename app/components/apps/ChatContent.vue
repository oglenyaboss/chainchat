  ...
  <div class="chat-layout">
    ...
    <div class="chat-sidebar win95-inset" :style="{ width: `${sidebarWidth}px` }">
      <div class="chat-sidebar__section">
        <div class="chat-sidebar__header">Channels</div>
        <ChatChannelList
      ...
      <Win95Divider />
      <div class="chat-sidebar__section">
        <div class="chat-sidebar__header">Peers ({{ peerStore.peerCount }})</div>
        <ChatPeerList
    ...
    <div class="chat-explorer win95-inset" :style="{ width: `${explorerWidth}px` }">
      <div class="chat-explorer__header">Latest Blocks</div>
