      ...
      <Win95Window title="ChainChat Setup Wizard" :active="true">
        <div class="wizard">
          ...
          <div class="wizard__header">
            <div class="wizard__header-icon">&#128187;</div>
            <div class="wizard__header-text">
              <template v-if="step === 0">Welcome to ChainChat</template>
              <template v-else-if="step === 1">Choose Your Nickname</template>
              <template v-else-if="step === 2">Generate Identity</template>
              <template v-else-if="step === 3">Setup Complete!</template>
            </div>
          </div>
          ...
          <div class="wizard__body">
            ...
            <div v-if="step === 0" class="wizard__step">
              ...
              <p class="wizard__hint">This wizard will help you set up your identity and connect to the network.</p>
              <p class="wizard__hint">Every message is a blockchain transaction. Every browser mines blocks.</p>
            </div>
            ...
            <div v-if="step === 1" class="wizard__step">
              ...
              <p v-if="nicknameError" class="wizard__error">{{ nicknameError }}</p>
              <p class="wizard__hint">3-20 characters, letters, numbers, underscores.</p>
              <p class="wizard__hint">Your nickname will be registered on the blockchain — no one else can claim it.</p>
            </div>

            <!-- Step 2: Generate Keys -->
            <div v-if="step === 2" class="wizard__step">
              <p v-if="!keysGenerated">Generating your cryptographic identity...</p>
              <div v-else>
            ...
            <div v-if="step === 3" class="wizard__step">
              ...
              <p class="wizard__hint">Click "Finish" to enter the network and start chatting.</p>
              <p class="wizard__hint">Your identity is stored in this browser session.</p>
            </div>
          </div>
          ...
          <div class="wizard__footer">
            <Win95Button :disabled="step === 0" @click="prevStep">&lt; Back</Win95Button>
            <Win95Button v-if="step < 3" variant="primary" @click="nextStep">Next &gt;</Win95Button>
            <Win95Button v-else variant="primary" @click="finish">Finish</Win95Button>
          </div>
        </div>
      </Win95Window>
    </div>
